...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="container row">
            <asp:GridView ID="GridCompras" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="5" OnPageIndexChanging="GridCompras_PageIndexChanging" CssClass="gridview-custom" OnSelectedIndexChanged="GridCompras_SelectedIndexChanged">
                <Columns>
